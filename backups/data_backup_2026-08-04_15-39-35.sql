...
-- \restrict LluCqaewAeL8texReEfSyvDkad81AogXBxqVRByYsni56eI9oNJgBRWNb8dyVyG
...
--
-- Data for Name: sistema_eventos_catalogo; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO "public"."sistema_eventos_catalogo" ("cod_evento", "descricao", "categoria") VALUES
...
INSERT INTO "public"."audit_log" ("id", "contrato_id", "usuario_uid", "usuario_email", "cod_evento", "descricao", "entidade_tipo", "entidade_id", "ip_origem", "criado_em") VALUES
	('9969a770-22b9-49fc-91ee-6adf7323fbf6', 'CTR-2026-SYS', '3G1JNHecTNNTimjaxkUxxTfb9qY2', 'sagacitas.sistemas@gmail.com', 'AUTH_LOGIN', 'Login efetuado com sucesso via google.com', 'usuario', '3G1JNHecTNNTimjaxkUxxTfb9qY2', NULL, '2026-08-04 15:08:56.192607+00');
...
INSERT INTO "public"."empresa_contratante" ("contrato_id", "natureza", "nome", "area", "departamento", "cnpj", "email", "telefone", "gestor_responsavel", "unidade_administrativa", "created_at", "updated_at") VALUES
	('CTR-2026-SYS', 'Privada', 'Sagacitas Sistemas', 'Tecnologia', 'Engenharia', NULL, NULL, NULL, NULL, NULL, '2026-08-04 14:44:20.256224+00', '2026-08-04 14:44:20.256224+00');
...
INSERT INTO "public"."empresas_fornecedores" ("id", "contrato_id", "nome", "cnpj_cpf", "tipo", "email_contato", "telefone", "status", "total_faturado", "created_at") VALUES
	('FORN-001', 'CTR-2026-SYS', 'Construtora Alpha Ltda', '11111111000111', 'FORNECEDOR', NULL, NULL, 'ATIVO', 0, NULL),
	('FORN-002', 'CTR-2026-SYS', 'Beta Instalações SA', '22222222000122', 'FORNECEDOR', NULL, NULL, 'ATIVO', 0, NULL),
	('FORN-003', 'CTR-2026-SYS', 'Gama Engenharia', '33333333000133', 'FORNECEDOR', NULL, NULL, 'BLOQUEADO', 0, NULL);
...
--
-- Data for Name: contratos_obra; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
INSERT INTO "public"."medicoes" ("id", "projeto_id", "numero_medicao", "data_medicao", "periodo_inicio", "periodo_fim", "status", "created_at", "contrato_obra_id") VALUES
	('dd47fb9e-3a17-41db-8f58-d5d0fb38264d', '0245894a-e335-4847-bfe2-55ea47439837', 1, '2026-08-02', '2026-07-01', '2026-07-31', 'APROVADO', '2026-08-02 14:01:20.085382+00', NULL);
...
--
-- Data for Name: permissoes_contratante; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO "public"."permissoes_contratante" ("id", "contrato_id", "empresas_criar", "empresas_ler", "empresas_editar", "empresas_excluir", "projetos_criar", "projetos_ler", "projetos_editar", "projetos_excluir", "medicoes_criar", "medicoes_ler", "medicoes_editar", "medicoes_excluir", "financeiro_criar", "financeiro_ler", "financeiro_editar", "financeiro_excluir", "relatorios_ler", "usuarios_criar", "usuarios_ler", "usuarios_editar", "usuarios_excluir", "created_at", "updated_at") VALUES
	('8bd644a5-ff3c-4764-af36-bf4ba78d39a1', 'CTR-2026-SYS', true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, '2026-08-04 14:44:20.335561+00', '2026-08-04 14:44:20.335561+00');


--
-- Data for Name: permissoes_empresa; Type: TABLE DATA; Schema: public; Owner: postgres
--



--
-- Data for Name: permissoes_tipo; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO "public"."permissoes_tipo" ("id", "contrato_id", "perfil", "empresas_criar", "empresas_ler", "empresas_editar", "empresas_excluir", "projetos_criar", "projetos_ler", "projetos_editar", "projetos_excluir", "medicoes_criar", "medicoes_ler", "medicoes_editar", "medicoes_excluir", "financeiro_criar", "financeiro_ler", "financeiro_editar", "financeiro_excluir", "relatorios_ler", "usuarios_criar", "usuarios_ler", "usuarios_editar", "usuarios_excluir", "created_at", "updated_at") VALUES
	('58265b2f-ad6f-49a8-b584-c2935f9ceb3c', 'CTR-2026-SYS', 'ADMIN', true, true, false, false, true, true, false, false, true, true, false, false, false, true, false, false, false, true, true, false, false, '2026-08-04 14:44:20.43016+00', '2026-08-04 14:44:20.43016+00'),
	('8f980d21-bf5d-4489-b44e-ab5150841252', 'CTR-2026-SYS', 'GESTOR', false, true, false, false, false, true, false, false, false, true, false, false, false, true, false, false, false, false, false, false, false, '2026-08-04 14:44:20.43016+00', '2026-08-04 14:44:20.43016+00'),
	('d90e3b91-9eb8-4d86-8809-2d5e03737d47', 'CTR-2026-SYS', 'FINANCEIRO', false, true, false, false, false, false, false, false, false, true, false, false, false, true, false, false, false, false, false, false, false, '2026-08-04 14:44:20.43016+00', '2026-08-04 14:44:20.43016+00'),
	('e6de654d-2845-4f9f-9cb3-dfedb78aae8e', 'CTR-2026-SYS', 'FORNECEDOR', false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, '2026-08-04 14:44:20.43016+00', '2026-08-04 14:44:20.43016+00'),
	('d165b47b-f19f-4bde-bed8-7edae9a9d43e', 'CTR-2026-SYS', 'VISITANTE', false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, '2026-08-04 14:44:20.43016+00', '2026-08-04 14:44:20.43016+00');
...
INSERT INTO "public"."usuarios" ("uid", "email", "nome", "foto_url", "contrato_id", "perfil", "status", "created_at", "updated_at", "claims_pendentes") VALUES
	('uid-gestor-mock', 'gestor@teste.com', 'Gestor de Obras (Teste)', NULL, 'CTR-2026-SYS', 'GESTOR', 'ATIVO', '2026-08-04 14:44:20.566673+00', '2026-08-04 14:44:20.566673+00', false),
	('uid-fornecedor-mock', 'fornecedor@teste.com', 'João Fornecedor (Teste)', NULL, 'CTR-2026-SYS', 'FORNECEDOR', 'ATIVO', '2026-08-04 14:44:20.566673+00', '2026-08-04 14:44:20.566673+00', false),
	('uid-visitante-mock', 'visitante@teste.com', 'Visitante (Teste)', NULL, 'CTR-2026-SYS', 'VISITANTE', 'ATIVO', '2026-08-04 14:44:20.566673+00', '2026-08-04 14:44:20.566673+00', false),
	('uid-bloqueado-mock', 'bloqueado@teste.com', 'Usuário Bloqueado', NULL, 'CTR-2026-SYS', 'FORNECEDOR', 'BLOQUEADO', '2026-08-04 14:44:20.566673+00', '2026-08-04 14:44:20.566673+00', false),
	('3G1JNHecTNNTimjaxkUxxTfb9qY2', 'sagacitas.sistemas@gmail.com', 'sagacitas sistemas', 'https://lh3.googleusercontent.com/a/ACg8ocJ4tp3ng2WpUHYXgot3Iee97F91S5LPPw1woaZ9QJwsQe6umgE=s96-c', 'CTR-2026-SYS', 'ADMIN', 'ATIVO', '2026-08-04 14:44:20.282741+00', '2026-08-04 14:44:20.282741+00', false);


--
-- Data for Name: permissoes_usuario; Type: TABLE DATA; Schema: public; Owner: postgres
--



--
-- Data for Name: system_error_log; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
-- \unrestrict LluCqaewAeL8texReEfSyvDkad81AogXBxqVRByYsni56eI9oNJgBRWNb8dyVyG
