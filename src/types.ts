export type NavigationTab = 'home' | 'login' | 'dashboard' | 'financeiro' | 'contratos' | 'alertas' | 'onboarding' | 'auth-debug' | 'empresas' | 'fornecedores' | 'equipes' | 'funcionarios' | 'maquinas' | 'ferramentas' | 'materiais' | 'entidades' | 'matriz-acesso' | 'usuarios' | 'projetos_eap' | 'ordens_servico' | 'contratos_obra' | 'audit-log' | 'parametros' | 'calendarios' | 'cronograma_executivo' | 'cronograma_financeiro' | 'rdo' | 'rdos_recebidos' | 'medicoes' | 'custos_financeiro' | 'dispositivos' | 'importacao_cub' | 'orcamento_base' | 'histograma' | 'bases_referenciais';
