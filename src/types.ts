export type NavigationTab = 'login' | 'dashboard' | 'financeiro' | 'contratos' | 'alertas' | 'onboarding' | 'auth-debug' | 'empresas' | 'entidades' | 'matriz-acesso' | 'usuarios' | 'projetos_eap' | 'contratos_obra' | 'audit-log' | 'parametros';
