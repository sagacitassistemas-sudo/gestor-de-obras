-- 1. Adiciona coluna de duracao_dias na tabela de itens_eap
ALTER TABLE public.itens_eap ADD COLUMN IF NOT EXISTS duracao_dias INT DEFAULT 1;

-- 2. Atualiza a view v_resumo_eap_medicao para expor a nova coluna
