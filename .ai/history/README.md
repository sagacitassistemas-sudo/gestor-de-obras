...
| 2026-08-21 | [Modularização e Arquitetura da API](2026-08-21_modularizacao_arquitetura_api.md) | Backend / Node.js | Fim do monólito `server.ts` e divisão da aplicação em 15 roteadores independentes separados por domínio. Ajustes na injeção do Supabase e Helpers. |
